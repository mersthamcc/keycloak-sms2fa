...
class ConditionalOtpSmsHelperTest {
    ...
    void processUpdateTests(String mobileNumber, boolean updateSucceeds) {
        ...
        assertThat(
                ConditionalOtpSmsHelper.processUpdate(user, updateForm(mobileNumber)),
                equalTo(updateSucceeds));
        if (updateSucceeds)
    ...
    void normalisePhoneNumberTestInternational() {
        assertThat(
                ConditionalOtpSmsHelper.normalisePhoneNumber("+1 222 333 4444"),
                equalTo("+12223334444"));
        assertThat(
                ConditionalOtpSmsHelper.normalisePhoneNumber("00 1 222 333 4444"),
                equalTo("+12223334444"));
    }
}
